  ...
  public var body: some View {
    TextStyleAttributesReader { attributes in
      BlockSequence(self.blocks.coalesced())
        ...
        .background(
          StyleProbe(types: [.paragraph, .heading(1), .heading(2), .heading(3), .heading(4), .heading(5), .heading(6), .bulletedList, .numberedList, .taskList, .blockquote, .listItem]) { styles in
